...
| **Sau vòng validation CP5 (31/07)** | **Thêm câu onboarding vào lời chào của Tutor**, hướng dẫn thao tác bôi đen → "Hỏi AI". | **Thay đổi trực tiếp từ feedback người dùng thật** (`validation/feedback-log.md`): 2/6 người thử không tự tìm ra thao tác bôi đen. Nguyễn Xuân Hải: *"cần thêm hướng dẫn bôi đen cho người mới"*. Bùi Xuân Hoà lúng túng lần đầu và là **người duy nhất không cam kết dùng thật**, điều kiện của họ đúng là *"nếu giao diện có hướng dẫn rõ ràng hơn"*. Bôi đen là thao tác lõi của lát cắt (bằng chứng CP1: giảm tỷ lệ "không tìm thấy nội dung" từ 21,1% xuống 2,0%) — người dùng không khám phá ra thì lợi thế đó mất trắng. |
| Sau vòng validation CP5 (31/07) | **Giữ nguyên** độ trễ phản hồi, không tối ưu. | 2/6 người nêu *"Tốc độ phản hồi chưa như mong đợi"*. Đo được 1–2,3 giây, gần như toàn bộ là thời gian gọi model thật. Rút ngắn phải đánh đổi bằng cắt ngữ cảnh đưa vào prompt — đúng nguyên nhân đã gây lỗi grounding giả ở lượt chạy 10 và phải sửa lại. Ưu tiên đúng hơn nhanh. |
