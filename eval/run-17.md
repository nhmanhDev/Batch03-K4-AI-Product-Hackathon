# Lượt chạy 17 — golden set 20 case

- Thời điểm: 2026-07-31T05:38:59.465Z
...
| C03 | ② | tóm tắt | 5 | deck | true | [2,3,5,10,11,13,14,15,18,20,22,23,24,26,27,28] | ⚠️ sufficient: cần false, được true; không hỏi lại để chốt phạm vi |
...
| C07 | ④ | tóm tắt cho tôi nội dung của bài này, chỉ ra | 7 | deck | true | [3,4,10,14,15,17,18,19,22,24,26,27] | ✅ pass |
...
| C11 | thường | tóm tắt cả bộ slide | 1 | deck | true | [2,3,4,5,8,9,10,11,12,13,14,15,17,18,19,20,21,22,23,24,26,27,28,29] | ✅ pass |
...
| C16 | thường | tại sao học viên cần hiểu cách LLM hoạt động | 2 | deck | true | [14,16,26,27,28] | ✅ pass |
...
- `answer`: "Buổi học hôm nay cung cấp cái nhìn tổng quan về nền tảng AI và LLM, bao gồm: lịch sử phát triển 70 năm của AI; cơ chế vận hành của LLM (Transformer, token, context, attention); quy trình huấn luyện model (Pre-training, SFT, RLHF); các hạn chế bẩm sinh (hallucination, knowledge cutoff); kỹ thuật cải "
- `missing`: (rỗng)
